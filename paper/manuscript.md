...
### 3.6. Study setting and participant consent
...
*Table 2. Historical speaker-state comparison with unannotated time coded as no-speaker. These are not validated accuracy estimates.*

| Reference state | Support | Recall |
| --- | --- | --- |
...
### 4.6. New baselines and validation sensitivity
...
*Table 3. Correct records out of 16 in paired evaluations. Session grouping does not separate recurring participants.*

| Model | 10-fold | Session-held-out |
| --- | --- | --- |
| Majority (ZeroR) | 7 | 7 |
